			...
			<div id="frame">		
				<div id="sidepanel">
					...
					foreach ($loggedUser as $user) {
						...
						echo '<img id="profile-img" src="userpics/" class="online" alt="" />';
					...
					foreach ($chatUsers as $user) {
						...
						echo '<li id="'.$user['user_id'].'" class="contact '.$activeUser.'" data-touserid="'.$user['user_id'].'" data-tousername="'.$user['user_phone'].'">';
						echo '<div class="wrap">';
						echo '<span id="status_'.$user['user_id'].'" class="contact-status '.$status.'"></span>';
						echo '<img src="userpics/" alt="" />';
						echo '<div class="meta">';
						echo '<p class="name">'.$user['user_phone'].'<span id="unread_'.$user['user_id'].'" class="unread">'.$chat->getUnreadMessageCount($user['user_id'], $_SESSION['username']).'</span></p>';
