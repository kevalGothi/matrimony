...
class Chat{
    ...
    private $user  = 'root';
    private $password   = "";
    private $database  = "matrimony";      
    private $chatTable = 'chat';
	private $chatUsersTable = 'tbl_user';
	...
	public function loginUsers($username, $password){
		$sqlQuery = "
			...
			WHERE user_phone='".$username."' AND user_pass='".$password."'";		
	...
	public function getUserChat($from_user_id, $to_user_id) {
		...
		foreach($userChat as $chat){
			...
			if($chat["sender_userid"] == $from_user_id) {
				...
				$conversation .= '<img width="22px" height="22px" src="userpics/" alt="" />';
			} else {
