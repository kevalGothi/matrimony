<?php
// =========================================================================
//  DEBUGGING CODE: Temporarily add these lines to see the error message.
// =========================================================================
...
// =========================================================================
//  1. PROCESS THE FORM (Run all PHP logic BEFORE any HTML is output)
// =========================================================================
session_start(); 

// --- Use __DIR__ for reliable file paths. This is the most likely fix. ---
...
if (isset($_POST['createuser'])) {
    ...
    if ($result_check->num_rows > 0) {
        ...
        $stmt_insert = $conn->prepare(
            "INSERT INTO tbl_user (user_gen_id, user_religion, user_name, user_gender, user_age, user_phone, user_email, user_pass, user_otp, user_status, user_payment_status, user_otp_status) 
             VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, '0', '0', '0')"
        );
        $stmt_insert->bind_param("ssssssssi", $genid, $religion, $name, $gender, $age, $phone, $email, $password_hash, $otp);
        ...
        if ($stmt_insert->execute()) {
            ...
            try {
                ...
                $mail->Body    = "<h2>Welcome!</h2><p>Your OTP is: <h3 style='color:#f6af04;'>$otp</h3></p>";
            ...
            $message = '<div class="alert alert-danger" role="alert">Error creating account. Please contact support.</div>';
            error_log("MySQLi Insert Error: " . $stmt_insert->error);
        }
    }
}

// =========================================================================
//  2. RENDER THE PAGE (Now that processing is done, print the HTML)
// =========================================================================
